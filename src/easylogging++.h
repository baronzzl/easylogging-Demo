...
#define ELPP_FORCE_USE_STD_THREAD // 强制使用c++标准库的线程，只有ELPP_THREAD_SAFE打开才有效
#define ELPP_NO_DEFAULT_LOG_FILE  // 禁止生成默认的日志文件
#define ELPP_FEATURE_CRASH_LOG  // 打开日志的程序崩溃处理
#define ELPP_STL_LOGGING // 打开stl数据类型支持
#ifdef QT_VERSION
#define ELPP_QT_LOGGING //打开Qt数据类型支持
#endif 
#ifdef BOOST_LIB
